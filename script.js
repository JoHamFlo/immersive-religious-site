const islamicNames = [
{n:1,arabic:'ٱلرَّحْمَـٰنُ',name:'Ar-Rahman',meaning:'The Beneficent',theology:'He wills goodness and mercy for all His creatures.',connection:'The LORD God, merciful — Exodus 34:6; [...]
{n:2,arabic:'ٱلرَّحِيمُ',name:'Ar-Raheem',meaning:'The Merciful',theology:'He acts with extreme kindness.',connection:'',tags:['mercy']},
{n:3,arabic:'ٱلْمَلِكُ',name:'Al-Malik',meaning:'The King',theology:'The Sovereign Lord with complete dominion, free from imperfection.',connection:'King of Kings; Jehovah-Hamelech — Psa[...]
...
{n:5,arabic:'ٱلسَّلَامُ',name:'As-Salam',meaning:'The Giver of Peace',theology:'Free from every defect; with Him comes tranquility.',connection:'Jehovah Shalom, The Lord is Peace — Judg[...]
...
{n:8,arabic:'ٱلْعَزِيزُ',name:'Al-Aziz',meaning:'The Mighty One',theology:'The strong Defender who is never defeated.',connection:'Jehovah-Ganan; Jehovah-Izoa Hakaboth — Psalm 89:18; Ps[...]
...
{n:11,arabic:'ٱلْخَالِقُ',name:'Al-Khaliq',meaning:'The Creator',theology:'He brings everything from non-existence into existence.',connection:'Jehovah Elohim; Jehovah-Bara — Genesis 2[...]
...
{n:17,arabic:'ٱلرَّزَّاقُ',name:'Ar-Razzaq',meaning:'The Total Provider',theology:'The Sustainer and Provider.',connection:'Jehovah Jireh, The Lord Will Provide — Genesis 22:14',tags:['sh[...]
...
{n:27,arabic:'ٱلْبَصِيرُ',name:'Al-Baseer',meaning:'The All-Seeing',theology:'He sees all things without physical instrument.',connection:'Jehovah Roi — Genesis 16:13',tags:['guidance'[...]
{n:28,arabic:'ٱلْحَكَمُ',name:'Al-Hakam',meaning:'The Impartial Judge',theology:'His judgment is authoritative and His judgment is His word.',connection:'Jehovah-Hashopet, Lord My Judge — J[...]
...
{n:33,arabic:'ٱلْعَظِيمُ',name:'Al-Azeem',meaning:'The Magnificent One',theology:'Deserving glory, exaltation, and purity from imperfection.',connection:'I AM THAT I AM; Jehovah-Kabodhi — [...]
...
{n:36,arabic:'ٱلْعَلِيُّ',name:'Al-Aliyy',meaning:'The Sublime One',theology:'The Most High, above created attributes.',connection:'Jehovah El Elyon, The Lord Most High — Psalm 7:17',tags:[...]
...
{n:67,arabic:'ٱلْأَحَدُ',name:'Al-Ahad',meaning:'The Sole One',theology:'The One.',connection:'Lord our God is One — Mark 12:29; Deuteronomy 6:4; Jehovah-Eli — Psalm 18:2',tags:['shar[...]
{n:68,arabic:'ٱلصَّمَدُ',name:'As-Samad',meaning:'The Supreme Provider',theology:'Eternal, independent, and relied upon in every need.',connection:'Jehovah Jireh; I AM THAT I AM — Genes[...]
...
{n:79,arabic:'ٱلْبَرُّ',name:'Al-Barr',meaning:'The Fountain-Head of Truth',theology:'The source of goodness, righteousness, and kindness to creation.',connection:'Jehovah Tsidkenu, The Lo[...]
...
{n:84,arabic:'مَالِكُ ٱلْمُلْكُ',name:'Malikul-Mulk',meaning:'The Eternal Possessor of Sovereignty',theology:'He controls dominion and gives dominion as He wills.',connection:'',ta[...]
{n:85,arabic:'ذُو ٱلْجَلَالِ وَٱلْإِكْرَامُ',name:'Dhul-Jalaali-Wal-Ikram',meaning:'The Possessor of Majesty and Honour',theology:'The Lord of majesty and bounty.',conne[...]
...
{n:93,arabic:'ٱلنُّورُ',name:'An-Noor',meaning:'The Prime Light',theology:'The Light and the One who guides.',connection:'Jehovah-Ori, Lord My Light — Psalm 27:1',tags:['guidance','share[...]
{n:94,arabic:'ٱلْهَادِي',name:'Al-Hadi',meaning:'The Provider of Guidance',theology:'The guide and leader of the right path.',connection:'Jehovah Nissi, The Lord My Banner — Exodus 17:1[...]
...
{title:'Muslims are terrorists or support violence',body:'Islam is described in the draft as a religion of peace and mercy that does not condone terrorism. Murder is treated as a major sin.',quot[...]
{title:'Muslim women are oppressed',body:'The draft distinguishes Islamic teaching from cultural practices that may mistreat women. It notes that Islam historically promoted women's rights in a[...]
{title:'Islam was spread only by the sword',body:'The draft explains that Islam also spread through trade and peaceful missionary work, especially in places such as Indonesia and sub-Saharan Afri[...]
{title:'All Muslims are Arabs',body:'Only a portion of Muslims worldwide are Arabs. Large Muslim populations live in Indonesia, Pakistan, India, and Bangladesh.',quote:'Islam is presented as a un[...]
{title:'Islam is intolerant of other religions',body:'The draft explains that Islam recognizes Jews and Christians as "People of the Book" and acknowledges shared Abrahamic heritage.',quote:'[...]
{title:'Jihad only means holy war',body:'The draft explains that jihad can mean struggle in the path of God and often refers to internal spiritual struggle.',quote:'Qur'an 22:78 is used to desc[...]
{title:'Muslims do not respect Jesus',body:'Islam honors Jesus, or Isa, as a highly respected prophet, affirms his miraculous birth, and identifies him as Messiah.',quote:'Qur'an 19:30 is used [...]
{title:'Sharia law is only barbaric',body:'The draft defines Sharia as a moral and legal framework connected to prayer, fasting, charity, justice, and daily life. Its application varies and is of[...]
{title:'Islam is anti-science',body:'The draft points to the Golden Age of Islam, when Muslim scholars contributed to medicine, mathematics, astronomy, and philosophy.',quote:'Qur'an 39:9 is us[...]
];
...
function renderIslamicNames(){
  ...
  grid.innerHTML = filtered.map(item => `
    <article class="name-card ${item.connection ? 'has-connection' : ''}" data-name-number="${item.n}">
  ...
  document.querySelectorAll('#islamicNamesGrid .name-card').forEach(card => {
    card.addEventListener('click', () => openTheologyPanel(card.dataset.nameNumber));
  });
}
...
function buildDeepPanel(item){
  ...
  const comparison = item.connection
    ? `This name overlaps with a Christian way of speaking about God: ${item.connection}. The connection is not saying both religions mean the exact same thing, but it shows a shared Abrahamic co[...]
    : 'This name does not have a specific Christian connection listed in the project draft, but it can still be compared with broader Christian themes such as holiness, sovereignty, mercy, judgme[...]
  return `
    ...
    <div class="deep-grid">
      ...
      <section class="deep-section"><h3>Why This Name Matters</h3><p>This name helps Muslims contemplate God through a specific divine attribute. It invites reflection on how God rules, guides, f[...]
...
function buildChristianDeepPanel(name, meaning, theology) {
  return `
    <p class="modal-eyebrow">Christian Name for God</p>
    <div class="modal-heading-row">
      <div><h2 id="modalTitle">${name}</h2><p class="modal-meaning">${meaning}</p></div>
    </div>
    <div class="deep-grid">
      <section class="deep-section"><h3>Theological Significance</h3><p>${theology}</p></section>
      <section class="deep-section"><h3>Why This Name Matters</h3><p>This name reveals an aspect of God's character and relationship with humanity. It helps believers understand God through a specific divine quality or role.</p></section>
    </div>
    <div class="reflection-box"><h3>Exhibit Reflection Question</h3><p>How does this name shape the way a believer understands God's relationship with humanity?</p></div>
  `;
}
...
function openChristianTheologyPanel(name, meaning, theology) {
  modalContent.innerHTML = buildChristianDeepPanel(name, meaning, theology);
  modal.classList.add('show');
  modal.setAttribute('aria-hidden', 'false');
  closeModalButton.focus();
}
...
function renderChristianNames(){
  document.querySelector('#christianNamesGrid').innerHTML = christianNames.map(([name,meaning,theology]) => `
    <article class="name-card christian-card" data-christian-name="${name}">
      <h3>${name}</h3>
  ...
  document.querySelectorAll('#christianNamesGrid .name-card').forEach(card => {
    card.addEventListener('click', () => {
      const nameData = christianNames.find(n => n[0] === card.dataset.christianName);
      if(nameData) openChristianTheologyPanel(nameData[0], nameData[1], nameData[2]);
    });
  });
}
